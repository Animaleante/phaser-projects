...
TheGame.prototype = {
    preload: function() {
        for (var i = 0; i < 10; i++) {
            game.load.spritesheet("cards"+i, "assets/sprites/cards"+i+".png", gameOptions.cardSheetWidth, gameOptions.cardSheetHeight);
        }

        game.load.spritesheet("info", "assets/sprites/info.png", 500, 184);
        game.load.spritesheet("swipe", "assets/sprites/swipe.png", 80, 130);
