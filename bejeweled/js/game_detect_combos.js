...
TheGame.prototype = {
    ...
    showSuggestion: function() {
        ...
        for (var i = 0; i < gameOptions.fieldSize - 1; i++) {
            for (var j = 0; j < gameOptions.fieldSize - 1; j++) {
                ...
                if(this.matchInBoard()) {
                    ...
                    this.handTween = game.add.tween(this.hand).to({
                        y: this.hand.y + 100
        ...
        // if code reaches here, not match can be made on this board
    },
                    ...
                    if(colorStreak >= 3) {
                        ...
                        switch(colorStreak) {
                            case 3:
                                ...
                                break;
                            case 4:
                                for (var k = 0; k < gameOptions.fieldSize; k++) {
                                    this.removeMap[k][i]++;
                                }
                                break;
                            default:
                                for (var k = 0; k < gameOptions.fieldSize; k++) {
                                    for (var l = 0; l < gameOptions.fieldSize; l++) {
